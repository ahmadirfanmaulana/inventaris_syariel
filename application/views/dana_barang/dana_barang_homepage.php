...
<div class="text-right">
  <?php
    if ($user_level != "admin") {
      ...
      ?>
      <a href="<?php echo PATH_THEME; ?>dana_barang/tambah">
...
foreach ($get_jb as $key) {
  ...
  <tr>
    ...
    <td><?php echo $key->dana_barang_tipe; ?></td>
    <?php
    if ($user_level != "admin") {
      # code...
    }
      ...
      <td class="text-center">
        <a href="<?php echo PATH_THEME; ?>dana_barang/edit/<?php echo $key->dana_barang_id; ?>">
          <button type="button" name="button" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</button>
        </a>

        <a href="<?php echo PATH_THEME; ?>dana_barang/hapus/<?php echo $key->dana_barang_id; ?>">
